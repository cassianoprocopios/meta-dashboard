...
export const notificacaoEventos = mysqlTable("notificacaoEventos", {
  ...
  tipo: mysqlEnum("tipo", ["meta_atingida", "mudanca_ranking", "meta_diaria_atingida", "meta_quinzenal_fechada"]).notNull(),
  empresaSlug: varchar("empresaSlug", { length: 64 }).notNull(),
...
export const cashbarberClientesMensais = mysqlTable("cashbarberClientesMensais", {
  ...
  clientesNovos: int("clientesNovos").notNull().default(0),
  clientesRecorrentes: int("clientesRecorrentes").notNull().default(0),
