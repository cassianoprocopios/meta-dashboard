/**
 * Script manual para sincronizar o faturamento do dia 22/05/2026 da Seraphine via Avec.
 * Executar com: npx tsx scripts/syncAvec2205.ts
 */
import { sincronizarFaturamentoAvecPorData } from "../server/avecSincronizador";

const TENANT_ID = 1;
const EMPRESA_SLUG = "barbiero-seraphine";
const DATA_INICIO = "2026-05-22";
const DATA_FIM = "2026-05-22";
